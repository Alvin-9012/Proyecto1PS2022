...
public class Damas1 {
	...
	public void CambioDeTurno() {
		if(color == 'R') {
			...
			color = 'R';
                        user.aumentarTotalMovimeitnosActuales();
		}
	}
	
	public Damas1(Users users) {
                this.user = users;
		tabla = new int[8][8];
	}
	...
	public int verdamas(int i,int j) {
        ...
        public int verdamasArchivos(int i,int j) {
		return tabla[i][j];
	}
